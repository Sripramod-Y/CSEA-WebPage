        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering the next generation of tech innovators through events, workshops, and community building.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-tech-600 rounded-lg flex items-center justify-center transition-colors duration-300">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <svg className="w-5 h-5 text-tech-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">info@techhub.com</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-tech-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
