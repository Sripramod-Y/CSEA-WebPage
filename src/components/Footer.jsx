          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center group">
                ...
                <span className="text-gray-300 group-hover:text-white transition-colors duration-300">123 Tech Street, Innovation City</span>
              </div>
              <div className="flex items-center group">
                ...
                <span className="text-gray-300 group-hover:text-white transition-colors duration-300">info@techhub.com</span>
              </div>
              <div className="flex items-center group">
